...
![UPGMA tree](results/TPI_UPGMA_tree.png)

**Figure 1.** UPGMA tree based on pairwise amino-acid p-distances calculated from the TPI alignment.
...
![Maximum-parsimony tree](results/TPI_parsimony_tree.png)

**Figure 2.** Best maximum-parsimony topology. Branch lengths are not proportional to evolutionary distance.
...
![Volcano plot](results/miRNA_volcano_plot.png)

**Figure 3.** Volcano plot of all 671 probes. Red points meet the historical nominal cutoff.

![Heatmap](results/miRNA_heatmap_top20.png)

**Figure 4.** Row-standardized expression of the 20 probes with the smallest nominal P-values.

![Selected miRNAs](results/selected_miRNA_expression.png)

**Figure 5.** Submitter-normalized expression distributions for the three historical-cutoff candidates.
